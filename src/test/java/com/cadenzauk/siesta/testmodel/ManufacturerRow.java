...
public class ManufacturerRow {
    ...
    public static final Table<ManufacturerRow, ManufacturerRow.Builder> TABLE = aTable("TEST", "MANUFACTURER", ManufacturerRow.Builder::new, ManufacturerRow.Builder::build, ManufacturerRow.class)
        .mandatory(MANUFACTURER_ID, ManufacturerRow::manufacturerId, ManufacturerRow.Builder::manufacturerId, TableColumn.Builder::primaryKey)
