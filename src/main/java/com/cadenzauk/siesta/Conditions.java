...
public class Conditions {
    ...
    public static <T> TestSupplier<T> isEqualTo(T value) {
        return scope -> new OperatorValueCondition<>("=", value);
    }

    public static <T, R> TestSupplier<T> isEqualTo(Column<T,R> column) {
        return scope -> new OperatorColumnCondition<>("=", scope.findAlias(column.rowClass()), column);
    }

    public static <T, R> TestSupplier<T> isEqualTo(String alias, Column<T,R> column) {
        return scope -> new OperatorColumnCondition<>("=", scope.findAlias(column.rowClass(), alias), column);
    }
